...
// @match       https://lyntron.test.on.plex.com/SalesAndCrm/QuoteWizard*
// @require      http://localhost:5000/lt-plex-tm-utils.user.js?v=3.8.138-1759273268344
// @require      http://localhost:5000/lt-plex-auth.user.js?v=3.8.138-1759273268344
// @require      http://localhost:5000/lt-ui-hub.js?v=3.8.138-1759273268344
// @require      http://localhost:5000/lt-data-core.user.js?v=3.8.138-1759273268344
// @require      http://localhost:5000/lt-core.user.js?v=3.8.138-1759273268344
