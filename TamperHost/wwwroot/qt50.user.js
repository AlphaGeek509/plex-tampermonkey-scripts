...
// @match       https://lyntron.test.on.plex.com/SalesAndCrm*
// @require      http://localhost:5000/lt-plex-tm-utils.user.js?v=2.0.47-1758148842682
// @require      http://localhost:5000/lt-plex-auth.user.js?v=2.0.47-1758148842682
// @require      http://localhost:5000/lt-ui-hub.js?v=2.0.47-1758148842682
// @require      http://localhost:5000/lt-core.user.js?v=2.0.47-1758148842682
// @require      http://localhost:5000/lt-data-core.user.js?v=2.0.47-1758148842682
      ...
      onClick: async () => {
        ...
        try {
          ...
          const keepAlive = setInterval(() => {
            ...
            if (++ticks >= 8) clearInterval(keepAlive);
          }, 750);
        } catch (err) {
