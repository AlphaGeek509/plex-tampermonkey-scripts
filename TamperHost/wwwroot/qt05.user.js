...
// @match       https://lyntron.test.on.plex.com/SalesAndCrm/QuoteWizard*
// @require     http://localhost:5000/lt-plex-tm-utils.user.js?v=3.9.23-1759506267116
// @require     http://localhost:5000/lt-plex-auth.user.js?v=3.9.23-1759506267116
// @require     http://localhost:5000/lt-ui-hub.js?v=3.9.23-1759506267116
// @require     http://localhost:5000/lt-data-core.user.js?v=3.9.23-1759506267116
// @require     http://localhost:5000/lt-core.user.js?v=3.9.23-1759506267116
