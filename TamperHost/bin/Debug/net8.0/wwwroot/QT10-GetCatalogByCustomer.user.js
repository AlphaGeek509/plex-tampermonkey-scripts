...
//
// DEVELOPMENT (only when you’re actively editing locally)
// @require      http://localhost:5000/lt-plex-auth.user.js
// @require      http://localhost:5000/lt-plex-tm-utils.user.js
//
// PERMISSION GRANTS note: GM_xmlhttpRequest needs @connect to allow calls to your Plex API
...
//
// AUTO-UPDATE (PRODUCTION) this is the one TamperMonkey watches for new versions
